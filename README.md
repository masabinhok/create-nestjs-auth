...
**v3.0.0** | **4 ORMs** (Prisma, Drizzle, TypeORM, Mongoose) | **4 Databases** (PostgreSQL, MySQL, SQLite, MongoDB)
...
<sub>
 ...
 <strong>v3.0.0</strong> | Multi-ORM & Multi-Database Support | December 2025 | MIT License
</sub>
